...
"{$p}pages"=>"id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,parent_id INT UNSIGNED NULL,author_id INT UNSIGNED,title VARCHAR(191),slug VARCHAR(191),content MEDIUMTEXT NULL,excerpt TEXT NULL,status VARCHAR(20),template VARCHAR(80) NULL,meta_title VARCHAR(191) NULL,meta_description TEXT NULL,meta_keywords TEXT NULL,canonical_path VARCHAR(191) NULL,og_title VARCHAR(191) NULL,og_description TEXT NULL,sort_order INT DEFAULT 0,locale VARCHAR(16) NOT NULL DEFAULT '',translation_of INT UNSIGNED NULL,published_at TIMESTAMP NULL,created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP",
"{$p}posts"=>"id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,author_id INT UNSIGNED,title VARCHAR(191),slug VARCHAR(191),content MEDIUMTEXT NULL,excerpt TEXT NULL,featured_image_id INT UNSIGNED NULL,featured_image VARCHAR(255) NULL,status VARCHAR(20),meta_title VARCHAR(191) NULL,meta_description TEXT NULL,canonical_path VARCHAR(191) NULL,og_title VARCHAR(191) NULL,og_description TEXT NULL,sort_order INT NOT NULL DEFAULT 0,locale VARCHAR(16) NOT NULL DEFAULT '',translation_of INT UNSIGNED NULL,published_at TIMESTAMP NULL,created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP",
...
// when config.php doesn't exist yet).
jura_seed_thankyou_page($pdo,$uid);
if (!empty($_POST['install_demo_data'])) { jura_seed_demo_posts($pdo,$uid); }
