...
$nav = array_merge(
  ['Core' => ['/admin'=>'Dashboard','/admin/settings'=>'Налаштування','/admin/pages'=>'Сторінки','/admin/posts'=>'Публікації','/admin/menus'=>'Меню','/admin/media'=>'Медіа','/admin/redirects'=>'Редіректи']],
