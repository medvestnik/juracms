  ...
  <?php else: ?>
    ...
    <div style="display:flex;gap:.6rem;flex-wrap:wrap;align-items:center">
      <form method="post" id="update-now-form">
        ...
        <button class="jura-btn jura-btn-primary" type="submit" id="update-now-btn" onclick="return confirm('Оновити Jura CMS до v<?= e($check['latest_version']) ?>? Перед оновленням буде створено резервну копію файлів у storage/backups/.')">⬇ Оновити зараз</button>
      </form>
