...
$actions = [
    ...
    'install_demo_data' => ['Встановити демо-дані', 'Додає кілька прикладів публікацій у блог. Безпечно виконувати повторно — вже додані записи не дублюються.'],
    'clear_cache' => ['Очистити кеш сторінок', 'Видаляє всі закешовані HTML-сторінки. Кеш також очищується автоматично при будь-якому збереженні в адмінці.'],
];
?>
