...
.project-card__image,.portfolio-card__image{margin:-1.5rem -1.5rem .75rem;border-radius:12px 12px 0 0;overflow:hidden;aspect-ratio:16/10}
.project-card__image img,.portfolio-card__image img{width:100%;height:100%;object-fit:cover;display:block}
</style>
